...
{
    public class PositiveNumberAttribute : ValidationAttributeBase
    {
        private bool IsZeroIncluded;

        /// <summary>
        /// A constructor of PositiveNumberAttribute class. The class derived from ValidationAttributeBase class.
        /// </summary>
        /// <param name="IsZeroIncluded">A flag that indicates whether to consider a 0 value as a valid validation result.</param>
        public PositiveNumberAttribute(bool IsZeroIncluded = false) : this(null, IsZeroIncluded) { }
        ...
        /// <param name="IsZeroIncluded">A flag that indicates whether to consider a 0 value as a valid validation result.</param>
        public PositiveNumberAttribute(string propertyName, bool IsZeroIncluded = false)
        {
        ...
        {
            return ValidateData.IsPositiveNumber(objectToValidate, IsZeroIncluded);
        }
    }
}
