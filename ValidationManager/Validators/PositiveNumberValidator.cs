...
{
    public class PositiveNumberValidator : Validator
    {
        private bool IsZeroIncluded;

        /// <summary>
        /// A constructor of PositiveNumberValidator class. The class derived from Validator class.
        /// </summary>
        ...
        public PositiveNumberValidator(object objectToValidate, bool IsZeroIncluded = false)
        {
        ...
        protected override bool ValidateReferenceType()
        {
            ...
            {
                return validatableObject.GreaterThanZero(IsZeroIncluded);
            }
            else
            {
                return false;
